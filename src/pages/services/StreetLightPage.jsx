          ...
          <div className="max-w-2xl">
            ...
            >
              ...
              <p className="text-slate-400 text-xl mb-12 font-light leading-relaxed">
                Autonomous, intelligent, and zero-maintenance lighting for the modern world.
                Dusk-to-dawn reliability powered by clean solar energy.
              </p>
              <Link
                to="/contact"
                className="inline-block bg-yellow-400 text-slate-900 px-10 py-4 rounded-full font-black uppercase tracking-tighter hover:bg-white hover:scale-105 transition-all shadow-[0_0_30px_rgba(250,204,21,0.3)]"
              >
                Get Bulk Quote
              </Link>
            </motion.div>
