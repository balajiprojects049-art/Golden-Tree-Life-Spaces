...
const ServicesPage = () => {
  return (
    <div className="bg-white">
      {/* Page Header */}
      <div className="bg-slate-900 pt-32 pb-32 relative overflow-hidden text-center text-white">
        <div className="absolute inset-0 opacity-20 bg-[radial-gradient(#22c55e_1px,transparent_1px)] [background-size:30px_30px]" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="text-primary font-bold tracking-[0.3em] uppercase text-[10px] mb-6 border border-primary/30 inline-block px-4 py-1 rounded">
               Service Portfolio
            </div>
            <h1 className="font-heading font-black text-6xl md:text-8xl mb-8 tracking-tighter italic italic-none">
              Energy <span className="text-primary">Evolved.</span>
            </h1>
            <p className="text-gray-400 max-w-2xl mx-auto text-xl font-light leading-relaxed">
              Industrial-grade engineering for residential, commercial, and rural infrastructure. We don't just install panels; we build sustainable legacies.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <div>
                 <h2 className="font-heading font-black text-4xl mb-8 uppercase tracking-tighter">The Engineering <span className="text-primary">Difference.</span></h2>
                 <div className="space-y-8">
                    {[
                      ...
                      <div key={i} className="flex gap-6">
                         <div className="shrink-0 w-1 bg-primary/30 group-hover:bg-primary transition-colors" />
                         <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {[
              ...
              <div key={i} className="bg-white p-10 rounded-2xl shadow-sm border border-gray-100 border-b-4 border-b-primary/20">
                 <h4 className="font-bold text-xl mb-4 text-slate-900 italic italic-none">Q: {faq.q}</h4>
      ...
      <section className="py-24 bg-slate-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-heading font-black text-4xl text-slate-900 mb-4 italic">Our Simple Solar Process</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
              Going solar shouldn't be complicated. We guide you through every step, from initial inquiry to final grid synchronization.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              <div key={i} className="text-center group">
                <div className="w-16 h-16 bg-white border-4 border-primary text-primary font-black text-xl rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-primary group-hover:text-white transition-all shadow-lg">
                  {s.step}
                </div>
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-white/80 text-lg mb-8">
            We specialize in large-scale commercial and industrial solar setups with high ROI and technical complexity.
          </p>
          <motion.button 
            whileHover={{ scale: 1.05 }}
            className="bg-white text-primary px-10 py-4 rounded-full font-black uppercase tracking-widest shadow-xl"
          >
